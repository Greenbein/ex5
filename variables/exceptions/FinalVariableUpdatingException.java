...
/**
 * this exception handles the case we trying to apply new value to a finalised variable
 */
public class FinalVariableUpdatingException extends RuntimeException {
  private static final String P1= "The variable called: ";
  private static final String P2= " ,cannot be updated, because it is " +
          "final and already initialized";
